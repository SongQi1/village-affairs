...
<body>
		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="${webctx}/home" title="主页" class="tip-bottom"><i
					...
					<a href="#" class="current">新增服务</a>
			</div>
		</div>
		<!--End-breadcrumbs-->

		<div class="container-fluid">
			<form action="${webctx}/volunteer/addService" method="post" id="form" class="form-horizontal">
	...
	<script>
		$("document").ready(function(){
			...
			uploader.on('uploadSuccess', function(file, response, src) {
			    //设置后台返回的图片id、删除上传进度
