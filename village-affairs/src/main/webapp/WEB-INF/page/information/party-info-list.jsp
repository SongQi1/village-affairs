			...
			<div class="container">
				...
				<div class="nav-collapse collapse" style="height: 0px;">
					<ul class="nav">
						...
						<li class="active"><a href="${webctx }/information/partyInfoList">党建服务</a></li>
	...
	<div class="container content">
		...
		<div id="breadcrumb">
			<a href="${webctx}" title="主页" class="tip-bottom"><i
				class="icon-home"></i>主页</a> <a href="#" class="current">党建服务</a>
		</div>
		...
		<div class="row-fluid">
			<div class="span4">
				<div class="widget-box">
					<div class="widget-title">
						<a href="${webctx}/information/communityPartyInfo?community=penglang" title="更多">
			...
			<div class="span4">
				<div class="widget-box">
					<div class="widget-title">
						<a href="${webctx}/information/communityPartyInfo?community=pengxii" title="更多">
							<span class="icon"> <i class="icon-list"></i></span>
						</a>
						<h5>蓬曦社区</h5>
					</div>
			...
			<div class="span4">
				<div class="widget-box">
					<div class="widget-title">
						<a href="${webctx}/information/communityPartyInfo?community=pengxin" title="更多">
							<span class="icon"> <i class="icon-list"></i></span>
						</a>
						<h5>蓬欣社区</h5>
					</div>
		...
		<div class="row-fluid">
			<div class="span4">
				<div class="widget-box">
					<div class="widget-title">
						<a href="${webctx}/information/communityPartyInfo?community=pengchen" title="更多">
							<span class="icon"> <i class="icon-list"></i></span>
						</a>
						<h5>蓬晨社区</h5>
					</div>
			...
			<div class="span4">
				<div class="widget-box">
					<div class="widget-title">
						<a href="${webctx}/information/communityPartyInfo?community=pengyuan" title="更多">
							<span class="icon"> <i class="icon-list"></i></span>
						</a>
						<h5>蓬苑社区</h5>
					</div>
			...
			<div class="span4">
				<div class="widget-box">
					<div class="widget-title">
						<a href="${webctx}/information/communityPartyInfo?community=penglai" title="更多">
							<span class="icon"> <i class="icon-list"></i></span>
						</a>
						<h5>蓬莱社区</h5>
					</div>
