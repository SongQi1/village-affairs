...
/**
 * author:lldy time:2012-5-6下午6:37:18 图片处理工具类：<br>
...
public class ImageUtil {
	 ...
	 * @throws IOException
	 */
	public static void resize(File originalFile, File resizedFile, int maxHeight, int maxWidth, float quality) throws IOException {  
        if (quality > 1) {  
